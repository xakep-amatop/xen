...
#define HW_REGISTER_BACKUP_SIZE 4  /* number of registers */
...
static int ipmmu_create_backup_for_dev(struct device *dev,
...
#ifdef CONFIG_SYSTEM_SUSPEND
    rc = ipmmu_create_backup_for_dev(dev, fwspec);
    if ( rc )
        return rc;
#endif
...
static __init int ipmmu_init(struct dt_device_node *node, const void *data)
{
    ...
    {
        /*
         * Perform platform specific actions such as power-on,
         * errata maintenance if required.
         */
