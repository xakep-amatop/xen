...
PERFCOUNTER(trap_wfi_pending_lpi, "trap: wfi pending LPI")
...
PERFCOUNTER(lpi_inject_blocked,   "LPI: inject to blocked vCPU")
PERFCOUNTER(lpi_inject_running,   "LPI: inject to running vCPU")
PERFCOUNTER(lpi_inject_runnable,  "LPI: inject to runnable vCPU")
PERFCOUNTER(lpi_kick_sched,       "LPI: kick-to-sched samples")
PERFCOUNTER(lpi_kick_sched_us,    "LPI: kick-to-sched us")
PERFCOUNTER(lpi_kick_sched_us_max, "LPI: kick-to-sched us per-cpu max")
PERFCOUNTER(lpi_kick_sched_lt_100us, "LPI: kick-to-sched <100us")
PERFCOUNTER(lpi_kick_sched_lt_1ms,   "LPI: kick-to-sched <1ms")
PERFCOUNTER(lpi_kick_sched_lt_10ms,  "LPI: kick-to-sched <10ms")
PERFCOUNTER(lpi_kick_sched_ge_10ms,  "LPI: kick-to-sched >=10ms")
PERFCOUNTER(lpi_doorbell_blocked,   "LPI: doorbell to blocked vCPU")
PERFCOUNTER(lpi_doorbell_running,   "LPI: doorbell to running vCPU")
PERFCOUNTER(lpi_doorbell_runnable,  "LPI: doorbell to runnable vCPU")
PERFCOUNTER(lpi_doorbell_sched,       "LPI: doorbell kick-to-sched samples")
PERFCOUNTER(lpi_doorbell_sched_us,    "LPI: doorbell kick-to-sched us")
PERFCOUNTER(lpi_doorbell_sched_us_max, "LPI: doorbell kick-to-sched us per-cpu max")
PERFCOUNTER(lpi_doorbell_sched_lt_100us, "LPI: doorbell kick-to-sched <100us")
PERFCOUNTER(lpi_doorbell_sched_lt_1ms,   "LPI: doorbell kick-to-sched <1ms")
PERFCOUNTER(lpi_doorbell_sched_lt_10ms,  "LPI: doorbell kick-to-sched <10ms")
PERFCOUNTER(lpi_doorbell_sched_ge_10ms,  "LPI: doorbell kick-to-sched >=10ms")
