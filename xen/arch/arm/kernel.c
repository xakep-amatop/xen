...
static bool __init
first_bank_can_fit_kernel_dtb_initrd(paddr_t ramsize, paddr_t kernbase,
                                     paddr_t kernend,
...
static bool __init
find_dtb_initrd_placement(paddr_t rambase, paddr_t ramend,
                          paddr_t kernbase, paddr_t kernend,
                          paddr_t dtb_initrd_size, paddr_t *dtb_base)
{
                                    ...
                                    paddr_t kernbase, paddr_t kernend)
{
    ...
    if ( !first_bank_can_fit_kernel_dtb_initrd(ramsize, kernbase, kernend,
                                               dtb_initrd_size) )
                                     ...
                                     paddr_t bank_size)
{
    ...
    return first_bank_can_fit_kernel_dtb_initrd(ramsize, kernbase, kernend,
                                                dtb_initrd_size) &&
           find_dtb_initrd_placement(rambase, ramend, kernbase, kernend,
                                     dtb_initrd_size, &dtb_base);
}
